...
import com.example.covid_19.HomeDashboardScreen;
...
public class StatisticsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CityWiseList = view.findViewById(R.id.CityWiseList);
        ...
        CardView_Line_Graph = view.findViewById(R.id.CardView_Line_Graph);
        first_card = view.findViewById(R.id.first_card);
        second_card = view.findViewById(R.id.second_card);
        Grid_Layout_second = view.findViewById(R.id.Grid_Layout_second);
        pushDown_Grid = view.findViewById(R.id.pushDown_Grid);
        changeGraphs = view.findViewById(R.id.changeGraphs);
        card_under_first_card = view.findViewById(R.id.card_under_first_card);

        //============================ Progress bar ============================================

        spin_kit_infected_number = view.findViewById(R.id.spin_kit_infected_number);
        Sprite doubleBounce = new ThreeBounce();
        spin_kit_infected_number.setIndeterminateDrawable(doubleBounce);

        spin_kit_recover_num = view.findViewById(R.id.spin_kit_recover_num);
        Sprite doubleBouncerecover_num = new ThreeBounce();
        spin_kit_recover_num.setIndeterminateDrawable(doubleBouncerecover_num);

        spin_kit_death_num = view.findViewById(R.id.spin_kit_death_num);
        Sprite doubleBouncerDeath_num = new ThreeBounce();
        spin_kit_death_num.setIndeterminateDrawable(doubleBouncerDeath_num);

        spin_kit_flag = view.findViewById(R.id.spin_kit_flag);
        Sprite doubleBouncerflag = new DoubleBounce();
        spin_kit_flag.setIndeterminateDrawable(doubleBouncerflag);

        Progress_Login_in = view.findViewById(R.id.Progress_Login_in);
        ...
        pushDown = view.findViewById(R.id.pushDown);
...
//declare
        confirmed_number = view.findViewById(R.id.confirmed_number);
        active_number = view.findViewById(R.id.active_number);
        recovered_number = view.findViewById(R.id.recovered_number);
        death_number = view.findViewById(R.id.death_number);
        NewRecovered_number = view.findViewById(R.id.NewRecovered_number);
        NewDeaths_number = view.findViewById(R.id.NewDeaths_number);
        btn_change = view.findViewById(R.id.btn_change);
        country = view.findViewById(R.id.country);
        country.setEnabled(false);
        infected_number = view.findViewById(R.id.infected_number);
        recover_county_number = view.findViewById(R.id.recover_county_number);
        death_number_country = view.findViewById(R.id.death_number_country);
                                ...
                                if (jsonObject.getString("name").equalsIgnoreCase(Country)) {
                                    ...
                                    getActivity().runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            GlideToVectorYou.justLoadImage(getActivity(), Uri.parse(flag_png), Country_flag);
                                            Progress_Login_in.setVisibility(View.INVISIBLE);
                                            btn_change.setVisibility(View.VISIBLE);
                                            country.setEnabled(false);
...
//
    ...
    public void showStateWiseDialog() {
        ...
        View alertView = (getActivity()).getLayoutInflater().inflate(R.layout.alert_dialouge_box_state, null);
